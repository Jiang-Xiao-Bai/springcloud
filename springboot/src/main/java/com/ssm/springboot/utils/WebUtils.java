...
public abstract class WebUtils {
	...
	public static Map<String,Object> headersMap = new HashMap<String,Object>();
	...
	public static String doPost2(String url, Map<String, String> params,Map<String, Object> headerMaps,
								 int connectTimeout, int readTimeout) throws IOException {
		headersMap = headerMaps;
		return doPost(url, params, DEFAULT_CHARSET, connectTimeout, readTimeout);
	}
	...
	public static String doGet2(String url, Map<String, String> params,Map<String, Object> headerMaps)
			throws IOException {
		headersMap = headerMaps;
		return doGet(url, params, DEFAULT_CHARSET);
	}
	 ...
	 * @throws IOException
	 */
	public static String setHeader(HttpURLConnection conn) {
		if (headersMap == null || headersMap.isEmpty()) {
			return null;
		}

		StringBuilder query = new StringBuilder();
		Set<Map.Entry<String, Object>> entries = headersMap.entrySet();
